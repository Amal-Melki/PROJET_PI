...
public class EspaceService implements Iservice {
    ...
    public void add(Object o) {
        ...
        String sql = "INSERT INTO Espace(nom, type, capacite, localisation, prix) VALUES(?, ?, ?, ?, ?)";
    ...
    public void update(Object o) {
        ...
        String sql = "UPDATE Espace SET nom=?, type=?, capacite=?, localisation=?, prix=? WHERE id=?";
    ...
    public List<Espace> get() {
        ...
        try {
            ...
            while (rs.next()) {
                    espace.add(new Espace(rs.getInt("id"),
                            rs.getString("nom"),
                            rs.getString("type"),
                            rs.getDouble("prix"),
                            rs.getInt("capacite"),
