            ...
            if (currentClient.getImage_path() != null && !currentClient.getImage_path().isEmpty()) {
                try {
                    ...
                    if (imagePath.startsWith("images/")) {
                        Image clientImage = new Image(getClass().getResourceAsStream("/" + imagePath));
                        if (clientImage.isError()) {
                            // If loading from resources fails, try loading from file system
                        ...
                        // If the path doesn't start with "images/", try loading as a direct file path
    ...
    private void loadDefaultAvatar() {
        try {
            ...
            if (defaultImage.isError()) {
                ...
                userImageView.setStyle("-fx-background-color: #ff7fa8; -fx-background-radius: 20;");
            } else {
